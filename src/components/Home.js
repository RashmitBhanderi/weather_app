    ...
    >
      ...
      >
        <Box sx={modalStyle}>
          ...
          Welcome to the Sunny the Weather app! Simply enter the name of a city in the search bar, and our website will provide you with real-time weather information for that time and hourly, including temperature, humidity, wind speed, and weather conditions, for that location. Stay informed and plan your day with ease using the Sunny!
          </Typography>
        </Box>
      </Modal>
    </div>
